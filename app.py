...
from src.charts import (
    ...
    bar_profit_by_subcategory,
    line_monthly_sales_profit,
    pie_sales_by_region
)
...
df_filtered = apply_filters(df, years=year_sel, regions=region_sel,
                            segments=segment_sel, categories=category_sel)
...
with tab3:
    st.dataframe(top_products(df_filtered))
